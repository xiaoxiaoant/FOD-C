...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 10, sizeof(::Qot_GetOptionChain::C2S)},
  { 15, 22, sizeof(::Qot_GetOptionChain::OptionItem)},
  { 24, 32, sizeof(::Qot_GetOptionChain::OptionChain)},
  { 35, 41, sizeof(::Qot_GetOptionChain::S2C)},
  { 42, 48, sizeof(::Qot_GetOptionChain::Request)},
  { 49, 58, sizeof(::Qot_GetOptionChain::Response)},
};
...
C2S::C2S(const C2S& from)
  ...
  ::memcpy(&type_, &from.type_,
    ...
    reinterpret_cast<char*>(&type_)) + sizeof(condition_));
...
void C2S::SharedCtor() {
  ...
  ::memset(&owner_, 0, static_cast<size_t>(
      ...
      reinterpret_cast<char*>(&owner_)) + sizeof(condition_));
}
