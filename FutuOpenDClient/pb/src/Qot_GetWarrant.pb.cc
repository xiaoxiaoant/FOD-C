...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 73, 120, sizeof(::Qot_GetWarrant::WarrantData)},
  { 162, 170, sizeof(::Qot_GetWarrant::S2C)},
  { 173, 179, sizeof(::Qot_GetWarrant::Request)},
  { 180, 189, sizeof(::Qot_GetWarrant::Response)},
};
...
WarrantData::WarrantData(const WarrantData& from)
  ...
  ::memcpy(&type_, &from.type_,
    static_cast<size_t>(reinterpret_cast<char*>(&effectiveleverage_) -
    reinterpret_cast<char*>(&type_)) + sizeof(effectiveleverage_));
...
void WarrantData::SharedCtor() {
  ...
  ::memset(&stock_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&effectiveleverage_) -
      reinterpret_cast<char*>(&stock_)) + sizeof(effectiveleverage_));
  _cached_size_ = 0;
}
...
// @@protoc_insertion_point(message_clear_start:Qot_GetWarrant.WarrantData)
  ...
  if (cached_has_bits & 768u) {
    ::memset(&delta_, 0, static_cast<size_t>(
        reinterpret_cast<char*>(&effectiveleverage_) -
        reinterpret_cast<char*>(&delta_)) + sizeof(effectiveleverage_));
  }
  _has_bits_.Clear();
  _internal_metadata_.Clear();
}
